...
export const translations = {
  fr: {
    ...
    landing: {
      ...
      eyebrow: 'YWCH 2026 · INNSBRUCK PREP',
      title: 'Check‑in matinal',
      ...
      profileLabel: 'Profil pour Arco',
      profileTopShape: 'Top shape',
      profileTopShapeHint: 'Visée podium · charge maximale',
      profileFatigueMgmt: 'Fatigue management',
      profileFatigueMgmtHint: 'Compétition · charge ajustée',
      profileNotCompeting: 'Pas en compétition',
      profileNotCompetingHint: "Camp d'entraînement seulement",
  ...
  en: {
    ...
    landing: {
      ...
      combined: 'Combined',
      combinedHint: 'Combined',
      profileLabel: 'Arco profile',
      profileTopShape: 'Top shape',
      profileTopShapeHint: 'Podium target · max load',
      profileFatigueMgmt: 'Fatigue management',
      profileFatigueMgmtHint: 'Competing · adjusted load',
