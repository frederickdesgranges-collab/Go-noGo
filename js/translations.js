...
export const translations = {
  fr: {
    ...
    wellbeing: {
      ...
      moodLow: 'Très basse',
      moodHigh: 'Excellente',
      skin: 'État de la peau (paumes / doigts)',
      skinLow: 'Abîmée',
      skinHigh: 'Au top',
    ...
    result: {
      ...
      refusedToast: 'Refus enregistré. Le coach voit ton nom et la discipline, aucun signal.',
      ...
      flagFreeTextPain: 'Douleur signalee dans la note',
      ...
      flagLowSkin: 'Peau abîmée',
      flagMidSkin: 'Peau à surveiller',
  ...
  en: {
    ...
    result: {
      ...
      refusedToast: 'Refusal logged. Coach sees your name and discipline, no signals.',
      ...
      flagFreeTextPain: 'Pain mentioned in note',
      ...
      flagLowSkin: 'Skin damaged',
      flagMidSkin: 'Skin to watch',
